...
namespace ApiServer.Migrations
{
    ...
    [Migration("20180604134116_addPixelvalue")]
    partial class addPixelvalue
    {
            ...
            modelBuilder.Entity("ApiServer.Model.ProjectSetting", b =>
                {
                    b.HasOne("ApiServer.Model.Project", "Project")
                        ...
                        .HasForeignKey("ApiServer.Model.ProjectSetting", "ProjectId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("ApiServer.Model.QuantityCheck", b =>
                {
                    b.HasOne("ApiServer.Model.Image", "Image")
                        .WithOne("QuantityCheck")
                        .HasForeignKey("ApiServer.Model.QuantityCheck", "ImageId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
