...
namespace ApiServer.Core.Authorization
{
    class VdsPermissionProvider: IPermissionProvider
    {
        ...
        public static readonly Permission ViewTag = new Permission { Name = VdsPermissions.ViewTag, DisplayName = "View", Description = "Allow to view Tag", Category = VdsPermissions.TagCategory };
        public static readonly Permission AddTag = new Permission { Name = VdsPermissions.AddTag, DisplayName = "Add", Description = "Allow to add Tag", Category = VdsPermissions.TagCategory };
        public static readonly Permission EditTag = new Permission { Name = VdsPermissions.EditTag, DisplayName = "Edit", Description = "Allow to modify Tag", Category = VdsPermissions.TagCategory };
        public static readonly Permission DeleteTag = new Permission { Name = VdsPermissions.DeleteTag, DisplayName = "Delete", Description = "Allow to delete Tag", Category = VdsPermissions.TagCategory };
